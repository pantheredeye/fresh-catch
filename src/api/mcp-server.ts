...
export const toolRegistry: Record<string, ToolRegistration> = {
  ...
  get_vendor_market_location: {
    description: "Returns a vendor's booth/location details at a specific market",
    schema: GetVendorMarketLocationInputSchema.shape,
    handler: handleGetVendorMarketLocation,
    tier: "read",
  },
  get_county_vendors: {
